                            ...
                            <div class="flex items-center justify-end w-56">
                                <div class="flex items-center justify-evenly flex-row w-5/12">
                                    ...
                                    <div class="flex items-center gap-1 rounded-sm h-12">
                                        <x-side-nav-link href="{{ route('user.messages') }}" :active="request()->routeIs('user.messages')" class="text-xl text-black font-medium mt-1 flex items-center w-full" id="chat-link">
                                        ...
                                        <span id="message-count" class="bg-red-600 text-white text-xs rounded-full px-2 ml-2" style="display: none;">0</span>
                                    </div>
